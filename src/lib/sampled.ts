...
import { discoverSvelteKitPageRouteFilesFromDirectory } from '../adapters/sveltekit/internal/discovery.js';
import { expandSvelteKitOptionalRoutes } from '../adapters/sveltekit/internal/optional-routes.js';
import { parseSvelteKitRouteTemplate } from '../adapters/sveltekit/internal/route-template.js';
import { filterSvelteKitRoutes } from '../adapters/sveltekit/internal/routes.js';
import { parseSitemapXml } from './xml.js';

export { listFilePathsRecursively } from '../adapters/sveltekit/internal/discovery.js';
...
export async function _sampledUrls(sitemapXml: string): Promise<string[]> {
  ...
  try {
    ...
    routes = discoverSvelteKitPageRouteFilesFromDirectory(path.join(projDir, 'src/routes'));
  } catch (err) {
  ...
  routes = filterSvelteKitRoutes(routes, []);
